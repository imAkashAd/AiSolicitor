...
class SpamCallWidget extends StatelessWidget {
  ...
  const SpamCallWidget({super.key, this.name, this.number, this.time, this.duration, this.avatar, this.onTap});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Image.asset(IconPath.spam, width: 40.w),
            SizedBox(width: 12.w),
            Expanded(
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Image.asset(IconPath.spamStatus, height: 20.h),
                    ],
                  ),
                  SizedBox(height: 4.h),
                  TextProperty(
                    text: number ?? '(+1) 987 654 3244',
