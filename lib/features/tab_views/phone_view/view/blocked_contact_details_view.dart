...
class BlockedContactDetailsView extends StatelessWidget {
  final String? name;
  final String? number;
  final String? avatar;
  
  const BlockedContactDetailsView({super.key, this.name, this.number, this.avatar});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: '',
        homePage: false,
        callStatus: IconPath.blockStatus,
      ),
