            ...
            children: [
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        TextProperty(
                          text: 'Important alerts & reminders.',
                        ...
                        Image.asset(IconPath.notification, width: 80.w, height: 90.h,),
                        SizedBox(height: 60.h),
                        CustomButton(
                          text: 'Continue',
                          onTap: () {},
              ...
              Padding(
                ...
                child: RichText(
                  textAlign: TextAlign.center,
                  text: TextSpan(
                  text: 'By using Pryve, you agree to the\n',
                  style: TextStyle(
                    fontFamily: 'SF Pro',
                    fontSize: 14.sp,
                    fontWeight: FontWeight.w400,
